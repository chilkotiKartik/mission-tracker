...
export function MissionCountdown() {
  ...
  useEffect(() => {
    // Set the event date and time to April 27, 7 PM
    const futureDate = new Date("2025-04-27T19:00:00");
      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-400">This IS Demo Plz Use demo Account for Check </p>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <div className="flex items-center text-purple-400">
                ...
                <span className="text-sm">25+ Agents Enlisted</span>
              </div>
            </div>
          </div>
